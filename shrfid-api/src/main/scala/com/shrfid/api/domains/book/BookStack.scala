...
object BookStackNested {
  ...
  def toDomain(id: String, bookStack: BookStack, bookBranch: Map[String, BookBranchWithId]): BookStackNested = {
    // Modified by kuangyuan 5/12/2017
    BookStackNested(id, bookStack.name, bookStack.is_active, bookStack.description, bookBranch.get(bookStack.branch) match {
      case None => Some(BookBranchWithId("Not Found", "Not Found", false, false, "Not Found", "Not Found", "Not Found"))
      case Some(s) => Some(s)
    }, bookStack.datetime)
  }
}
