...
case class GetBookItemByBarcodesRequest(@Header Authorization: String,
                                      @QueryParam barcode_string: String)

// Added by kuangyuan 5/12/2017
case class GetBookFineByBarcodeRequest(@Header Authorization: String,
