...
////val finagleHttpxVersion = "latests'c.integration"
//val scroogeVersion = "latest.integration" + suffix
//val libThriftVersion = "latest.integration"
//val finatraVersion = "latest.integration"
//val guiceVersion = "latest.integration"
//val logbackVersion = "latest.integration"
//val twitterServerVersion = "latest.integration"
//val mockitoCoreVersion = "latest.integration"
//val scalaTestVersion = "latest.integration"
//val specs2Version = "latest.integration"
//val typesafeConfigVersion = "latest.integration"
//val finagleOAuth2Version = "latest.integration"
//val jwtScalaVersion = "latest.integration"
...
//      "com.sksamuel.elastic4s" % "elastic4s-core_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-json4s_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-jackson_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-play-json_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-circe_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-embedded_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-streams_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-testkit_2.11" % "latest.integration",
//      "com.sksamuel.elastic4s" % "elastic4s-core-tests_2.11" % "latest.integration",
...
/*
 * Added by Kuang 2017-03-17
 */
lazy val `elastic-service` = (project in file("elastic-service")).dependsOn(shrfidCommon).settings(commonSettings: _*)
  .settings(
    libraryDependencies ++= Seq(
    )
  )
...
val runAll = inputKey[Unit]("Compiles and runs all subprojects")

runAll := {
  (run in Compile in `elastic-service`).evaluated
}
...
// enables unlimited amount of resources to be used :-o just for r2unAll convenience
